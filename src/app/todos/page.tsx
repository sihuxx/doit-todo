  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-8">
      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-slate-800 tracking-tight">전체 할일</h1>
      ...
      {showAdd && (
        <AddTodoForm
          ...
          onAdd={async (title, catId, dueDate) => {
            await addTodo(title, catId, dueDate);
          }}
      ...
      {todos.length === 0 && (
        <div className="flex flex-col items-center justify-center py-20 text-center">
          <svg width="48" height="48" viewBox="0 0 48 48" fill="none" className="mb-3 opacity-20">
            ...
            <path d="M20 18l2 2 4-4" stroke="#3B82F6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
          <p className="text-slate-400 text-sm">아직 할일이 없어요</p>
          <p className="text-slate-300 text-xs mt-1">"할일 추가" 버튼을 눌러보세요</p>
        </div>
      )}
